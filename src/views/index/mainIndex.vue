<template>
  <div>
    ...
    <el-row>
      <el-col :span="24">
        <new-echarts id="newEcharts" height="300px;" width="100%" ref="echarts"></new-echarts>
      </el-col>
    </el-row>
  </div>
</template>
...
import NewEcharts from '../../components/ECharts/newEcharts'
export default {
  name: 'mainIndex',
  components: {LineEcharts,NewEcharts},
  mounted () {
    this.selfAdaption()
  },
  methods: {
